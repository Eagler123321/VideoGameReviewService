...
public class ReviewResponseDto {
    ...
    @Schema(description = "Detailed review comment", example = "This is a nice and cute game", requiredMode = Schema.RequiredMode.REQUIRED)
    private String comment;
    @Schema(description = "Only YYYY.MM.DD", example = "2020-09-13T12:00:00", requiredMode = Schema.RequiredMode.REQUIRED)
    private LocalDateTime createdAt;
    @Schema(description = "Only YYYY.MM.DD", example = "2024-09-13T12:00:00", requiredMode = Schema.RequiredMode.REQUIRED)
